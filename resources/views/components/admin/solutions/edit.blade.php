      ...
      <div class="self-center lg:w-2/3">
        <div class="space-beetween flex">
          <h1 class="text-2xl font-bold text-primary lg:text-3xl">
            Edit <span class="text-secondary">Solution</span>
          </h1>
          <button
        ...
        <form class="mt-5" method="post" action="/solutions/{{ $solution['id'] }}">
          @method('put')
          @csrf
          <div class="w-full lg:mx-auto">
            ...
            <div class="mb-4 w-full px-4">
              ...
              <input type="text" id="solution " name="solution" value="{{ @old('solution', $solution['solution']) }}"
